...
RSpec.describe Legion::Extensions::Affordance::Helpers::AffordanceField do
  subject(:field) { described_class.new }

  let(:constants) { Legion::Extensions::Affordance::Helpers::Constants }
  ...
  describe '#detect_affordance' do
    it 'creates an affordance' do
      ...
      expect(aff).to be_a(Legion::Extensions::Affordance::Helpers::AffordanceItem)
